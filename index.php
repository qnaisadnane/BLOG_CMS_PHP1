...
// Récupérer tous les articles publiés (simple SELECT)
...
<body class="bg-gray-50">
    ...
    <section class="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-5xl font-bold mb-4">Bienvenue sur BlogCMS</h2>
            <p class="text-xl mb-8">Découvrez des articles passionnants et partagez vos commentaires</p>
            <div class="flex justify-center space-x-4">
                <div class="bg-white/20 backdrop-blur-lg rounded-lg p-6">
                    <p class="text-3xl font-bold"><?= count($articles) ?></p>
                    <p class="text-sm">Articles publiés</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-gray-50">
        <div class="container mx-auto px-4">
            <h3 class="text-3xl font-bold text-center mb-8 text-gray-800">Tous les Articles</h3>
                            ...
                            <div class="p-8">
                                ...
                                <div class="border-t pt-6 mt-6">
                                    <h3 class="text-2xl font-bold text-gray-800 mb-6">
                                        <i class="far fa-comments mr-2"></i>Commentaires (<?= count($comments) ?>)
                                    </h3>
